...
class OpDef_ArgDef extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('OpDef_ArgDef')
    ..aOS(1, 'name')
    ..aOS(2, 'description')
    ..e<DataType>(3, 'type', PbFieldType.OE, DataType.DT_INVALID, DataType.valueOf, DataType.values)
    ..aOS(4, 'typeAttr')
    ..aOS(5, 'numberAttr')
    ..aOS(6, 'typeListAttr')
    ..aOB(16, 'isRef')
  ...
  OpDef_ArgDef() : super();
  OpDef_ArgDef.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  OpDef_ArgDef.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static OpDef_ArgDef getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyOpDef_ArgDef();
...
class OpDef_AttrDef extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('OpDef_AttrDef')
    ..aOS(1, 'name')
    ..aOS(2, 'type')
    ..a<AttrValue>(3, 'defaultValue', PbFieldType.OM, AttrValue.getDefault, AttrValue.create)
    ..aOS(4, 'description')
    ..aOB(5, 'hasMinimum')
    ..aInt64(6, 'minimum_6')
    ..a<AttrValue>(7, 'allowedValues', PbFieldType.OM, AttrValue.getDefault, AttrValue.create)
    ..hasRequiredFields = false
  ;

  OpDef_AttrDef() : super();
  OpDef_AttrDef.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  OpDef_AttrDef.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static OpDef_AttrDef getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyOpDef_AttrDef();
    return _defaultInstance;
  }
  ...
  set defaultValue(AttrValue v) { setField(3, v); }
...
class OpDef extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('OpDef')
    ..aOS(1, 'name')
    ..pp<OpDef_ArgDef>(2, 'inputArg', PbFieldType.PM, OpDef_ArgDef.$checkItem, OpDef_ArgDef.create)
    ..pp<OpDef_ArgDef>(3, 'outputArg', PbFieldType.PM, OpDef_ArgDef.$checkItem, OpDef_ArgDef.create)
    ..pp<OpDef_AttrDef>(4, 'attr', PbFieldType.PM, OpDef_AttrDef.$checkItem, OpDef_AttrDef.create)
    ..aOS(5, 'summary')
    ..aOS(6, 'description')
    ..a<OpDeprecation>(8, 'deprecation', PbFieldType.OM, OpDeprecation.getDefault, OpDeprecation.create)
    ..aOB(16, 'isAggregate')
    ..aOB(17, 'isStateful')
  ...
  OpDef() : super();
  OpDef.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  OpDef.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  set summary(String v) { $_setString(4, v); }
...
class OpDeprecation extends GeneratedMessage {
  ...
  OpDeprecation() : super();
  OpDeprecation.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  OpDeprecation.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static OpDeprecation getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyOpDeprecation();
    return _defaultInstance;
  }
  ...
  set explanation(String v) { $_setString(1, v); }
...
class OpList extends GeneratedMessage {
  ...
  OpList() : super();
  OpList.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  OpList.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
