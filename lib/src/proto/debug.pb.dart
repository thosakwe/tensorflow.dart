...
class DebugTensorWatch extends GeneratedMessage {
  ...
  DebugTensorWatch.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DebugTensorWatch.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  DebugTensorWatch clone() => new DebugTensorWatch()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static DebugTensorWatch create() => new DebugTensorWatch();
  static PbList<DebugTensorWatch> createRepeated() => new PbList<DebugTensorWatch>();
  static DebugTensorWatch getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyDebugTensorWatch();
  ...
  set outputSlot(int v) { $_setUnsignedInt32(1, v); }
  ...
  set tolerateDebugOpCreationFailures(bool v) { $_setBool(4, v); }
  bool hasTolerateDebugOpCreationFailures() => $_has(4);
  void clearTolerateDebugOpCreationFailures() => clearField(5);
}

class _ReadonlyDebugTensorWatch extends DebugTensorWatch with ReadonlyMessageMixin {}

class DebugOptions extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('DebugOptions')
    ..pp<DebugTensorWatch>(4, 'debugTensorWatchOpts', PbFieldType.PM, DebugTensorWatch.$checkItem, DebugTensorWatch.create)
    ..aInt64(10, 'globalStep')
    ..hasRequiredFields = false
  ;

  DebugOptions() : super();
  DebugOptions.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DebugOptions.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static DebugOptions getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyDebugOptions();
    return _defaultInstance;
  }
  ...
  set globalStep(Int64 v) { $_setInt64(1, v); }
...
class DebuggedSourceFile extends GeneratedMessage {
  ...
  DebuggedSourceFile.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DebuggedSourceFile.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  DebuggedSourceFile clone() => new DebuggedSourceFile()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static DebuggedSourceFile create() => new DebuggedSourceFile();
  static PbList<DebuggedSourceFile> createRepeated() => new PbList<DebuggedSourceFile>();
  static DebuggedSourceFile getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyDebuggedSourceFile();
    return _defaultInstance;
  }
...
class _ReadonlyDebuggedSourceFile extends DebuggedSourceFile with ReadonlyMessageMixin {}

class DebuggedSourceFiles extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('DebuggedSourceFiles')
    ..pp<DebuggedSourceFile>(1, 'sourceFiles', PbFieldType.PM, DebuggedSourceFile.$checkItem, DebuggedSourceFile.create)
    ..hasRequiredFields = false
  ;

  DebuggedSourceFiles() : super();
  DebuggedSourceFiles.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  DebuggedSourceFiles.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  DebuggedSourceFiles clone() => new DebuggedSourceFiles()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static DebuggedSourceFiles create() => new DebuggedSourceFiles();
  static PbList<DebuggedSourceFiles> createRepeated() => new PbList<DebuggedSourceFiles>();
  static DebuggedSourceFiles getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyDebuggedSourceFiles();
    return _defaultInstance;
  }
...
class _ReadonlyDebuggedSourceFiles extends DebuggedSourceFiles with ReadonlyMessageMixin {}
