...
class CostGraphDef_Node_InputInfo extends GeneratedMessage {
  ...
  CostGraphDef_Node_InputInfo.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  CostGraphDef_Node_InputInfo.fromJson(String i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  CostGraphDef_Node_InputInfo clone() =>
      new CostGraphDef_Node_InputInfo()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static CostGraphDef_Node_InputInfo create() =>
      new CostGraphDef_Node_InputInfo();
  static PbList<CostGraphDef_Node_InputInfo> createRepeated() =>
      new PbList<CostGraphDef_Node_InputInfo>();
  static CostGraphDef_Node_InputInfo getDefault() {
    if (_defaultInstance == null)
      _defaultInstance = new _ReadonlyCostGraphDef_Node_InputInfo();
    return _defaultInstance;
  }

  static CostGraphDef_Node_InputInfo _defaultInstance;
  static void $checkItem(CostGraphDef_Node_InputInfo v) {
    if (v is! CostGraphDef_Node_InputInfo)
      checkItemFailed(v, 'CostGraphDef_Node_InputInfo');
  }

  int get precedingNode => $_get(0, 0);
  set precedingNode(int v) {
...
class _ReadonlyCostGraphDef_Node_InputInfo extends CostGraphDef_Node_InputInfo
...
class CostGraphDef_Node_OutputInfo extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('CostGraphDef_Node_OutputInfo')
    ...
    ..a<TensorShapeProto>(3, 'shape', PbFieldType.OM,
        TensorShapeProto.getDefault, TensorShapeProto.create)
    ..e<DataType>(4, 'dtype', PbFieldType.OE, DataType.DT_INVALID,
        DataType.valueOf, DataType.values)
    ..hasRequiredFields = false;

  CostGraphDef_Node_OutputInfo() : super();
  CostGraphDef_Node_OutputInfo.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  CostGraphDef_Node_OutputInfo.fromJson(String i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  CostGraphDef_Node_OutputInfo clone() =>
      new CostGraphDef_Node_OutputInfo()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static CostGraphDef_Node_OutputInfo create() =>
      new CostGraphDef_Node_OutputInfo();
  static PbList<CostGraphDef_Node_OutputInfo> createRepeated() =>
      new PbList<CostGraphDef_Node_OutputInfo>();
  static CostGraphDef_Node_OutputInfo getDefault() {
    if (_defaultInstance == null)
      _defaultInstance = new _ReadonlyCostGraphDef_Node_OutputInfo();
    return _defaultInstance;
  }

  static CostGraphDef_Node_OutputInfo _defaultInstance;
  static void $checkItem(CostGraphDef_Node_OutputInfo v) {
    if (v is! CostGraphDef_Node_OutputInfo)
      checkItemFailed(v, 'CostGraphDef_Node_OutputInfo');
  }
...
class _ReadonlyCostGraphDef_Node_OutputInfo extends CostGraphDef_Node_OutputInfo
    with ReadonlyMessageMixin {}
...
class CostGraphDef_Node extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('CostGraphDef_Node')
    ...
    ..pp<CostGraphDef_Node_InputInfo>(
        4,
        'inputInfo',
        PbFieldType.PM,
        CostGraphDef_Node_InputInfo.$checkItem,
        CostGraphDef_Node_InputInfo.create)
    ..pp<CostGraphDef_Node_OutputInfo>(
        5,
        'outputInfo',
        PbFieldType.PM,
        CostGraphDef_Node_OutputInfo.$checkItem,
  ...
  CostGraphDef_Node.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  CostGraphDef_Node.fromJson(String i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  CostGraphDef_Node clone() => new CostGraphDef_Node()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static CostGraphDef_Node create() => new CostGraphDef_Node();
  static PbList<CostGraphDef_Node> createRepeated() =>
      new PbList<CostGraphDef_Node>();
  static CostGraphDef_Node getDefault() {
    if (_defaultInstance == null)
      _defaultInstance = new _ReadonlyCostGraphDef_Node();
    return _defaultInstance;
  }
...
class _ReadonlyCostGraphDef_Node extends CostGraphDef_Node
    with ReadonlyMessageMixin {}

class CostGraphDef extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('CostGraphDef')
    ..pp<CostGraphDef_Node>(1, 'node', PbFieldType.PM,
        CostGraphDef_Node.$checkItem, CostGraphDef_Node.create)
    ..hasRequiredFields = false;

  CostGraphDef() : super();
  CostGraphDef.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  CostGraphDef.fromJson(String i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  static CostGraphDef getDefault() {
    if (_defaultInstance == null)
      _defaultInstance = new _ReadonlyCostGraphDef();
    return _defaultInstance;
  }
