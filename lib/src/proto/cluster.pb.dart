...
class JobDef_TasksEntry extends GeneratedMessage {
  ...
  JobDef_TasksEntry.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  JobDef_TasksEntry.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static PbList<JobDef_TasksEntry> createRepeated() => new PbList<JobDef_TasksEntry>();
  static JobDef_TasksEntry getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyJobDef_TasksEntry();
...
class _ReadonlyJobDef_TasksEntry extends JobDef_TasksEntry with ReadonlyMessageMixin {}

class JobDef extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('JobDef')
    ..aOS(1, 'name')
    ..pp<JobDef_TasksEntry>(2, 'tasks', PbFieldType.PM, JobDef_TasksEntry.$checkItem, JobDef_TasksEntry.create)
    ..hasRequiredFields = false
  ;

  JobDef() : super();
  JobDef.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  JobDef.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class ClusterDef extends GeneratedMessage {
  ...
  ClusterDef() : super();
  ClusterDef.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ClusterDef.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
