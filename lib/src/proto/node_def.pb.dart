...
class NodeDef_AttrEntry extends GeneratedMessage {
  ...
  NodeDef_AttrEntry.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  NodeDef_AttrEntry.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static PbList<NodeDef_AttrEntry> createRepeated() => new PbList<NodeDef_AttrEntry>();
  static NodeDef_AttrEntry getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyNodeDef_AttrEntry();
...
class _ReadonlyNodeDef_AttrEntry extends NodeDef_AttrEntry with ReadonlyMessageMixin {}
...
class NodeDef extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('NodeDef')
    ...
    ..pPS(3, 'input')
    ..aOS(4, 'device')
    ..pp<NodeDef_AttrEntry>(5, 'attr', PbFieldType.PM, NodeDef_AttrEntry.$checkItem, NodeDef_AttrEntry.create)
    ..hasRequiredFields = false
  ;

  NodeDef() : super();
  NodeDef.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  NodeDef.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  set op(String v) { $_setString(1, v); }
  bool hasOp() => $_has(1);
  ...
  set device(String v) { $_setString(3, v); }
