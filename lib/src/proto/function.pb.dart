...
class FunctionDefLibrary extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('FunctionDefLibrary')
    ..pp<FunctionDef>(1, 'function', PbFieldType.PM, FunctionDef.$checkItem, FunctionDef.create)
    ..pp<GradientDef>(2, 'gradient', PbFieldType.PM, GradientDef.$checkItem, GradientDef.create)
    ..hasRequiredFields = false
  ;

  FunctionDefLibrary() : super();
  FunctionDefLibrary.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  FunctionDefLibrary.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  FunctionDefLibrary clone() => new FunctionDefLibrary()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static FunctionDefLibrary create() => new FunctionDefLibrary();
  static PbList<FunctionDefLibrary> createRepeated() => new PbList<FunctionDefLibrary>();
  static FunctionDefLibrary getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyFunctionDefLibrary();
...
class _ReadonlyFunctionDefLibrary extends FunctionDefLibrary with ReadonlyMessageMixin {}
...
class FunctionDef_AttrEntry extends GeneratedMessage {
  ...
  FunctionDef_AttrEntry.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  FunctionDef_AttrEntry.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  FunctionDef_AttrEntry clone() => new FunctionDef_AttrEntry()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static FunctionDef_AttrEntry create() => new FunctionDef_AttrEntry();
  static PbList<FunctionDef_AttrEntry> createRepeated() => new PbList<FunctionDef_AttrEntry>();
  static FunctionDef_AttrEntry getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyFunctionDef_AttrEntry();
    return _defaultInstance;
  }
  static FunctionDef_AttrEntry _defaultInstance;
  static void $checkItem(FunctionDef_AttrEntry v) {
    if (v is! FunctionDef_AttrEntry) checkItemFailed(v, 'FunctionDef_AttrEntry');
  }
...
class _ReadonlyFunctionDef_AttrEntry extends FunctionDef_AttrEntry with ReadonlyMessageMixin {}
...
class FunctionDef_RetEntry extends GeneratedMessage {
  ...
  FunctionDef_RetEntry.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  FunctionDef_RetEntry.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  FunctionDef_RetEntry clone() => new FunctionDef_RetEntry()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static FunctionDef_RetEntry create() => new FunctionDef_RetEntry();
  static PbList<FunctionDef_RetEntry> createRepeated() => new PbList<FunctionDef_RetEntry>();
  static FunctionDef_RetEntry getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyFunctionDef_RetEntry();
    return _defaultInstance;
  }
...
class _ReadonlyFunctionDef_RetEntry extends FunctionDef_RetEntry with ReadonlyMessageMixin {}
...
class FunctionDef extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('FunctionDef')
    ...
    ..pp<NodeDef>(3, 'nodeDef', PbFieldType.PM, NodeDef.$checkItem, NodeDef.create)
    ..pp<FunctionDef_RetEntry>(4, 'ret', PbFieldType.PM, FunctionDef_RetEntry.$checkItem, FunctionDef_RetEntry.create)
    ..pp<FunctionDef_AttrEntry>(5, 'attr', PbFieldType.PM, FunctionDef_AttrEntry.$checkItem, FunctionDef_AttrEntry.create)
    ..hasRequiredFields = false
  ;

  FunctionDef() : super();
  FunctionDef.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  FunctionDef.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  set signature(OpDef v) { setField(1, v); }
...
class GradientDef extends GeneratedMessage {
  ...
  GradientDef() : super();
  GradientDef.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  GradientDef.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
