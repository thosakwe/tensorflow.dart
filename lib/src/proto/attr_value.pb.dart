...
class AttrValue_ListValue extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('AttrValue_ListValue')
    ...
    ..pp<DataType>(6, 'type', PbFieldType.KE, DataType.$checkItem, null, DataType.valueOf, DataType.values)
    ..pp<TensorShapeProto>(7, 'shape', PbFieldType.PM, TensorShapeProto.$checkItem, TensorShapeProto.create)
    ..pp<TensorProto>(8, 'tensor', PbFieldType.PM, TensorProto.$checkItem, TensorProto.create)
    ..pp<NameAttrList>(9, 'func', PbFieldType.PM, NameAttrList.$checkItem, NameAttrList.create)
    ..hasRequiredFields = false
  ;

  AttrValue_ListValue() : super();
  AttrValue_ListValue.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AttrValue_ListValue.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  AttrValue_ListValue clone() => new AttrValue_ListValue()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static AttrValue_ListValue create() => new AttrValue_ListValue();
  static PbList<AttrValue_ListValue> createRepeated() => new PbList<AttrValue_ListValue>();
  static AttrValue_ListValue getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyAttrValue_ListValue();
...
class _ReadonlyAttrValue_ListValue extends AttrValue_ListValue with ReadonlyMessageMixin {}

class AttrValue extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('AttrValue')
    ..a<AttrValue_ListValue>(1, 'list', PbFieldType.OM, AttrValue_ListValue.getDefault, AttrValue_ListValue.create)
    ..a<List<int>>(2, 's', PbFieldType.OY)
    ..aInt64(3, 'i')
    ..a<double>(4, 'f', PbFieldType.OF)
    ..aOB(5, 'b')
    ..e<DataType>(6, 'type', PbFieldType.OE, DataType.DT_INVALID, DataType.valueOf, DataType.values)
    ..a<TensorShapeProto>(7, 'shape', PbFieldType.OM, TensorShapeProto.getDefault, TensorShapeProto.create)
    ..a<TensorProto>(8, 'tensor', PbFieldType.OM, TensorProto.getDefault, TensorProto.create)
    ..aOS(9, 'placeholder')
    ..a<NameAttrList>(10, 'func', PbFieldType.OM, NameAttrList.getDefault, NameAttrList.create)
    ..hasRequiredFields = false
  ;

  AttrValue() : super();
  AttrValue.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  AttrValue.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class NameAttrList_AttrEntry extends GeneratedMessage {
  ...
  NameAttrList_AttrEntry.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  NameAttrList_AttrEntry.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  NameAttrList_AttrEntry clone() => new NameAttrList_AttrEntry()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static NameAttrList_AttrEntry create() => new NameAttrList_AttrEntry();
  static PbList<NameAttrList_AttrEntry> createRepeated() => new PbList<NameAttrList_AttrEntry>();
  static NameAttrList_AttrEntry getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyNameAttrList_AttrEntry();
    return _defaultInstance;
  }
  static NameAttrList_AttrEntry _defaultInstance;
  static void $checkItem(NameAttrList_AttrEntry v) {
    if (v is! NameAttrList_AttrEntry) checkItemFailed(v, 'NameAttrList_AttrEntry');
  }
...
class _ReadonlyNameAttrList_AttrEntry extends NameAttrList_AttrEntry with ReadonlyMessageMixin {}

class NameAttrList extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('NameAttrList')
    ..aOS(1, 'name')
    ..pp<NameAttrList_AttrEntry>(2, 'attr', PbFieldType.PM, NameAttrList_AttrEntry.$checkItem, NameAttrList_AttrEntry.create)
    ..hasRequiredFields = false
  ;

  NameAttrList() : super();
  NameAttrList.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  NameAttrList.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static NameAttrList getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyNameAttrList();
    return _defaultInstance;
  }
