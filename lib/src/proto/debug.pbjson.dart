...
const DebugTensorWatch$json = const {
  ...
  '2': const [
    ...
    const {'1': 'tolerate_debug_op_creation_failures', '3': 5, '4': 1, '5': 8, '10': 'tolerateDebugOpCreationFailures'},
  ],
};
...
const DebugOptions$json = const {
  '1': 'DebugOptions',
  '2': const [
    const {'1': 'debug_tensor_watch_opts', '3': 4, '4': 3, '5': 11, '6': '.tensorflow.DebugTensorWatch', '10': 'debugTensorWatchOpts'},
...
const DebuggedSourceFiles$json = const {
  ...
  '2': const [
    const {'1': 'source_files', '3': 1, '4': 3, '5': 11, '6': '.tensorflow.DebuggedSourceFile', '10': 'sourceFiles'},
  ],
};
