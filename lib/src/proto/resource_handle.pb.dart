...
class ResourceHandleProto extends GeneratedMessage {
  ...
  ResourceHandleProto.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  ResourceHandleProto.fromJson(String i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ResourceHandleProto clone() =>
      new ResourceHandleProto()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static ResourceHandleProto create() => new ResourceHandleProto();
  static PbList<ResourceHandleProto> createRepeated() =>
      new PbList<ResourceHandleProto>();
  static ResourceHandleProto getDefault() {
    if (_defaultInstance == null)
      _defaultInstance = new _ReadonlyResourceHandleProto();
...
class _ReadonlyResourceHandleProto extends ResourceHandleProto
