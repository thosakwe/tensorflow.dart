...
class GPUOptions_Experimental_VirtualDevices extends GeneratedMessage {
  static final BuilderInfo _i =
      new BuilderInfo('GPUOptions_Experimental_VirtualDevices')
        ..p<double>(1, 'memoryLimitMb', PbFieldType.PF)
        ..hasRequiredFields = false;

  GPUOptions_Experimental_VirtualDevices() : super();
  GPUOptions_Experimental_VirtualDevices.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  GPUOptions_Experimental_VirtualDevices.fromJson(String i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  GPUOptions_Experimental_VirtualDevices clone() =>
      new GPUOptions_Experimental_VirtualDevices()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static GPUOptions_Experimental_VirtualDevices create() =>
      new GPUOptions_Experimental_VirtualDevices();
  static PbList<GPUOptions_Experimental_VirtualDevices> createRepeated() =>
      new PbList<GPUOptions_Experimental_VirtualDevices>();
  static GPUOptions_Experimental_VirtualDevices getDefault() {
    if (_defaultInstance == null)
      _defaultInstance = new _ReadonlyGPUOptions_Experimental_VirtualDevices();
  ...
  static void $checkItem(GPUOptions_Experimental_VirtualDevices v) {
    if (v is! GPUOptions_Experimental_VirtualDevices)
      checkItemFailed(v, 'GPUOptions_Experimental_VirtualDevices');
  }

  List<double> get memoryLimitMb => $_getList(0);
}

class _ReadonlyGPUOptions_Experimental_VirtualDevices
    extends GPUOptions_Experimental_VirtualDevices with ReadonlyMessageMixin {}
...
class GPUOptions_Experimental extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('GPUOptions_Experimental')
    ..pp<GPUOptions_Experimental_VirtualDevices>(
        1,
        'virtualDevices',
        PbFieldType.PM,
        GPUOptions_Experimental_VirtualDevices.$checkItem,
        GPUOptions_Experimental_VirtualDevices.create)
    ..hasRequiredFields = false;

  GPUOptions_Experimental() : super();
  GPUOptions_Experimental.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  GPUOptions_Experimental.fromJson(String i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  GPUOptions_Experimental clone() =>
      new GPUOptions_Experimental()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static GPUOptions_Experimental create() => new GPUOptions_Experimental();
  static PbList<GPUOptions_Experimental> createRepeated() =>
      new PbList<GPUOptions_Experimental>();
  static GPUOptions_Experimental getDefault() {
    if (_defaultInstance == null)
      _defaultInstance = new _ReadonlyGPUOptions_Experimental();
    return _defaultInstance;
  }

  static GPUOptions_Experimental _defaultInstance;
  static void $checkItem(GPUOptions_Experimental v) {
    if (v is! GPUOptions_Experimental)
      checkItemFailed(v, 'GPUOptions_Experimental');
  }

  List<GPUOptions_Experimental_VirtualDevices> get virtualDevices =>
      $_getList(0);
}

class _ReadonlyGPUOptions_Experimental extends GPUOptions_Experimental
...
class GPUOptions extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('GPUOptions')
    ...
    ..a<GPUOptions_Experimental>(9, 'experimental', PbFieldType.OM,
        GPUOptions_Experimental.getDefault, GPUOptions_Experimental.create)
    ..hasRequiredFields = false;

  GPUOptions() : super();
  GPUOptions.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  GPUOptions.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  set perProcessGpuMemoryFraction(double v) {
    $_setDouble(0, v);
  }
  ...
  set visibleDeviceList(String v) {
    $_setString(4, v);
  }
  ...
  set pollingActiveDelayUsecs(int v) {
  ...
  set pollingInactiveDelayMsecs(int v) {
...
class OptimizerOptions extends GeneratedMessage {
  ...
  OptimizerOptions.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  OptimizerOptions.fromJson(String i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  OptimizerOptions clone() => new OptimizerOptions()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static OptimizerOptions create() => new OptimizerOptions();
  static PbList<OptimizerOptions> createRepeated() =>
      new PbList<OptimizerOptions>();
  static OptimizerOptions getDefault() {
    if (_defaultInstance == null)
      _defaultInstance = new _ReadonlyOptimizerOptions();
    return _defaultInstance;
  }
  ...
  set doCommonSubexpressionElimination(bool v) {
    $_setBool(0, v);
  }
...
class _ReadonlyOptimizerOptions extends OptimizerOptions
    with ReadonlyMessageMixin {}
...
class GraphOptions extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('GraphOptions')
    ...
    ..a<OptimizerOptions>(3, 'optimizerOptions', PbFieldType.OM,
    ...
    ..a<RewriterConfig>(10, 'rewriteOptions', PbFieldType.OM,
        RewriterConfig.getDefault, RewriterConfig.create)
    ..hasRequiredFields = false;

  GraphOptions() : super();
  GraphOptions.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  GraphOptions.fromJson(String i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  static GraphOptions getDefault() {
    if (_defaultInstance == null)
      _defaultInstance = new _ReadonlyGraphOptions();
    return _defaultInstance;
  }
  ...
  set enableRecvScheduling(bool v) {
    $_setBool(0, v);
  }
  ...
  set enableBfloat16Sendrecv(bool v) {
    $_setBool(5, v);
  }
  ...
  set rewriteOptions(RewriterConfig v) {
    setField(10, v);
  }
...
class ThreadPoolOptionProto extends GeneratedMessage {
  ...
  ThreadPoolOptionProto.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  ThreadPoolOptionProto.fromJson(String i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ThreadPoolOptionProto clone() =>
      new ThreadPoolOptionProto()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static ThreadPoolOptionProto create() => new ThreadPoolOptionProto();
  static PbList<ThreadPoolOptionProto> createRepeated() =>
      new PbList<ThreadPoolOptionProto>();
  static ThreadPoolOptionProto getDefault() {
    if (_defaultInstance == null)
      _defaultInstance = new _ReadonlyThreadPoolOptionProto();
    return _defaultInstance;
  }

  static ThreadPoolOptionProto _defaultInstance;
  static void $checkItem(ThreadPoolOptionProto v) {
    if (v is! ThreadPoolOptionProto)
      checkItemFailed(v, 'ThreadPoolOptionProto');
  }

  int get numThreads => $_get(0, 0);
  set numThreads(int v) {
...
class _ReadonlyThreadPoolOptionProto extends ThreadPoolOptionProto
    with ReadonlyMessageMixin {}
...
class RPCOptions extends GeneratedMessage {
  ...
  RPCOptions() : super();
  RPCOptions.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  RPCOptions.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  set useRpcForInprocessMaster(bool v) {
    $_setBool(0, v);
  }
...
class ConfigProto_DeviceCountEntry extends GeneratedMessage {
  ...
  ConfigProto_DeviceCountEntry.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  ConfigProto_DeviceCountEntry.fromJson(String i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ConfigProto_DeviceCountEntry clone() =>
      new ConfigProto_DeviceCountEntry()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static ConfigProto_DeviceCountEntry create() =>
      new ConfigProto_DeviceCountEntry();
  static PbList<ConfigProto_DeviceCountEntry> createRepeated() =>
      new PbList<ConfigProto_DeviceCountEntry>();
  static ConfigProto_DeviceCountEntry getDefault() {
    if (_defaultInstance == null)
      _defaultInstance = new _ReadonlyConfigProto_DeviceCountEntry();
    return _defaultInstance;
  }

  static ConfigProto_DeviceCountEntry _defaultInstance;
  static void $checkItem(ConfigProto_DeviceCountEntry v) {
    if (v is! ConfigProto_DeviceCountEntry)
      checkItemFailed(v, 'ConfigProto_DeviceCountEntry');
  }
...
class _ReadonlyConfigProto_DeviceCountEntry extends ConfigProto_DeviceCountEntry
    with ReadonlyMessageMixin {}

class ConfigProto extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('ConfigProto')
    ..pp<ConfigProto_DeviceCountEntry>(
        1,
        'deviceCount',
        PbFieldType.PM,
        ConfigProto_DeviceCountEntry.$checkItem,
        ConfigProto_DeviceCountEntry.create)
    ...
    ..a<GPUOptions>(6, 'gpuOptions', PbFieldType.OM, GPUOptions.getDefault,
        GPUOptions.create)
    ..aOB(7, 'allowSoftPlacement')
    ..aOB(8, 'logDevicePlacement')
    ..aOB(9, 'usePerSessionThreads')
    ..a<GraphOptions>(10, 'graphOptions', PbFieldType.OM,
        GraphOptions.getDefault, GraphOptions.create)
    ..aInt64(11, 'operationTimeoutInMs')
    ..pp<ThreadPoolOptionProto>(12, 'sessionInterOpThreadPool', PbFieldType.PM,
        ThreadPoolOptionProto.$checkItem, ThreadPoolOptionProto.create)
    ..a<RPCOptions>(13, 'rpcOptions', PbFieldType.OM, RPCOptions.getDefault,
        RPCOptions.create)
    ..a<ClusterDef>(14, 'clusterDef', PbFieldType.OM, ClusterDef.getDefault,
        ClusterDef.create)
    ..aOB(15, 'isolateSessionState')
    ..hasRequiredFields = false;

  ConfigProto() : super();
  ConfigProto.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  ConfigProto.fromJson(String i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  set intraOpParallelismThreads(int v) {
    $_setUnsignedInt32(1, v);
  }
  ...
  set interOpParallelismThreads(int v) {
  ...
  set usePerSessionThreads(bool v) {
    $_setBool(8, v);
  }
  ...
  set isolateSessionState(bool v) {
    $_setBool(14, v);
  }
...
class RunOptions extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('RunOptions')
    ...
    ..a<DebugOptions>(6, 'debugOptions', PbFieldType.OM,
        DebugOptions.getDefault, DebugOptions.create)
    ..aOB(7, 'reportTensorAllocationsUponOom')
    ..hasRequiredFields = false;

  RunOptions() : super();
  RunOptions.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  RunOptions.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  set outputPartitionGraphs(bool v) {
    $_setBool(3, v);
  }
  ...
  set reportTensorAllocationsUponOom(bool v) {
    $_setBool(5, v);
  }
...
class RunMetadata extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('RunMetadata')
    ..a<StepStats>(
        1, 'stepStats', PbFieldType.OM, StepStats.getDefault, StepStats.create)
    ..a<CostGraphDef>(2, 'costGraph', PbFieldType.OM, CostGraphDef.getDefault,
        CostGraphDef.create)
    ..pp<GraphDef>(3, 'partitionGraphs', PbFieldType.PM, GraphDef.$checkItem,
        GraphDef.create)
    ..hasRequiredFields = false;

  RunMetadata() : super();
  RunMetadata.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  RunMetadata.fromJson(String i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class TensorConnection extends GeneratedMessage {
  ...
  TensorConnection.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  TensorConnection.fromJson(String i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  TensorConnection clone() => new TensorConnection()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static TensorConnection create() => new TensorConnection();
  static PbList<TensorConnection> createRepeated() =>
      new PbList<TensorConnection>();
  static TensorConnection getDefault() {
    if (_defaultInstance == null)
      _defaultInstance = new _ReadonlyTensorConnection();
    return _defaultInstance;
  }
...
class _ReadonlyTensorConnection extends TensorConnection
    with ReadonlyMessageMixin {}
...
class CallableOptions extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('CallableOptions')
    ...
    ..pPS(2, 'fetch')
    ..pPS(3, 'target')
    ..a<RunOptions>(4, 'runOptions', PbFieldType.OM, RunOptions.getDefault,
        RunOptions.create)
    ..pp<TensorConnection>(5, 'tensorConnection', PbFieldType.PM,
        TensorConnection.$checkItem, TensorConnection.create)
    ..hasRequiredFields = false;

  CallableOptions() : super();
  CallableOptions.fromBuffer(List<int> i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  CallableOptions.fromJson(String i,
      [ExtensionRegistry r = ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  CallableOptions clone() => new CallableOptions()..mergeFromMessage(this);
  BuilderInfo get info_ => _i;
  static CallableOptions create() => new CallableOptions();
  static PbList<CallableOptions> createRepeated() =>
      new PbList<CallableOptions>();
  static CallableOptions getDefault() {
    if (_defaultInstance == null)
      _defaultInstance = new _ReadonlyCallableOptions();
    return _defaultInstance;
  }
...
class _ReadonlyCallableOptions extends CallableOptions
    with ReadonlyMessageMixin {}
